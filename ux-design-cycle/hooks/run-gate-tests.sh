...
root_a="$work/a"
setup_root "$root_a" "drafting"
payload_a="$(json_write "$root_a" "drafting" "collected_note: still gathering\n")"
...
# still resolved and judged this repo's own ux-design/state.md rather than
