...
YOU_DECIDE="YOU DECIDE: whether a phase-2 interaction-design record contains a distinct task/interaction-flow artifact — its own heading, separate from any wireframe-headed section, with real (non-stub) content"
